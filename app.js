...
async function uploadSelectedMedia(){
  ...
  return {mediaUrl, mediaType:selectedFile.type.startsWith("video/") ? "video" : "image"};
}
...
Object.assign(window,{toast,toggleMenu,showPage,searchItems,addPost,addSelectedPost,choosePostType,selectMediaFile,handleMediaSelected,openAuthModal,closeAuthModal,signUpUser,signInUser,logoutUser,openGroupForm,closeGroupForm,addGroup,addListing,submitJoin,likePost,commentPost,joinGroup,loginAdmin,logoutAdmin,adminAddBusiness,adminAddEvent,deleteItem,populateStates,loadMajorCities});
